...
/**
 * @brief modifica el año de ingreso a la selecc
 *
 * @param figurita
 * @param clubes
 * @param tamClub
...
/**
 * @brief obtengo el nombre del representante mediante una relación
 *
 * @param figurita
 * @param representantes
 * @param tamRepresentantes
...
/**
 * @brief obtengo el nombre de la seleccion mediante una relación
 *
 * @param unaFigurita
 * @param selecciones
 * @param tamSeleccion
...
/**
 * @brief obtengo el nombre del club mediante una relación
 *
 * @param unaFigurita
 * @param clubes
 * @param tamClub
